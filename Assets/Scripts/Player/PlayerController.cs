...
namespace Player
{
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        [Tooltip("Camêra default")]
        public CinemachineCamera walkCamera;
        [Tooltip("Camêra de corrida")]
        public CinemachineCamera sprintCamera;
        [Tooltip("Camêra de mira")]
        ...
        private void Move()
        {
            ...
            if (_isStrafe)
            {
                ...
                if (_animator)
                {
                    ...
                    _animator.SetFloat("X", Mathf.Lerp(currentX, inputDirection.x, Time.deltaTime * SpeedChangeRate));
                    _animator.SetFloat("Y", Mathf.Lerp(currentY, inputDirection.z, Time.deltaTime * SpeedChangeRate));
                }
            } else
            {
        ...
        private void Aiming()
        {
            ...
            aimCamera.enabled = _input.aim;
            _isStrafe = _input.aim;
        }

        private void SprintCam()
        {
            sprintCamera.enabled = (_input.sprint && _speed > MoveSpeed);
        }
